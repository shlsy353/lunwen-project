    ...
    <div class="page-container">
        ...
        <el-card class="table-card" shadow="never">
            ...
            <el-table :data="tableData" v-loading="loading" stripe class="data-table">
                ...
                <el-table-column label="参赛状态" width="110" align="center">
                    <template #default="{ row }">
                        <el-tag :type="statusType(row.status)">{{ statusText(row.status) }}</el-tag>
                    </template>
                </el-table-column>
                <el-table-column prop="reviewComment" label="备注" min-width="200" show-overflow-tooltip />
    ...
    try {
        const res = await request.get('/registration/page', {
            params: {
                ...
                status: 1  // Only show confirmed participants
            }
        })
