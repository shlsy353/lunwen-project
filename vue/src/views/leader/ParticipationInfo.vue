  ...
  <div class="page-container">
    ...
    <el-card class="table-card" shadow="never">
      <div class="search-bar">
        ...
        <el-input v-model="searchStudId" placeholder="学号..." clearable style="width: 140px" />
        <el-button type="success" @click="load" :icon="Search">检索参赛记录</el-button>
      ...
      <el-table :data="tableData" v-loading="loading" stripe class="data-table">
        ...
        <el-table-column prop="studentId" label="学生學號" width="100" align="center" />
        <el-table-column label="参与状态" width="110" align="center">
          <template #default="{ row }">
            <el-tag :type="statusType(row.status)">{{ statusText(row.status) }}</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="reviewComment" label="过程记录/备注" min-width="200" show-overflow-tooltip />
        <el-table-column prop="createTime" label="首报日期" width="180" />
      </el-table>
...
const statusText = (s: number) => ['待定', '实参', '拒审', '晋级'][s] ?? '未知'
